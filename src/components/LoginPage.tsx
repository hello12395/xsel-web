        ...
        <div className="relative w-full max-w-[440px]">
          ...
          <div className="overflow-hidden rounded-[28px] border border-[#e4ebf5] bg-white shadow-[0_24px_60px_-28px_rgba(18,22,74,0.28),0_8px_20px_-12px_rgba(18,22,74,0.08)]">
            ...
            <div className="px-6 py-7 sm:px-8 sm:py-8">
              {loginRequired ? (
                <p className="mb-5 rounded-[14px] border border-[#e8d59a] bg-[#fff8e6] px-4 py-3 text-[13px] leading-5 text-[#8a6d1a]">
                  Sign in to view premium courses. New here? Create an account first.
                </p>
              ) : null}

              {registered ? (
                <p className="mb-5 rounded-[14px] border border-forest/20 bg-forest/5 px-4 py-3 text-[13px] leading-5 text-forest">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between gap-3 pt-1">
                  <label className="group flex cursor-pointer items-center gap-2.5 text-[13px] text-ink/50">
                    ...
                    <span className="transition group-hover:text-ink/70">Remember me</span>
                  </label>

                  <button
                    type="button"
                    className="text-[13px] font-semibold text-forest underline decoration-forest/20 underline-offset-[3px] transition hover:decoration-forest"
                  >
                    Forgot password?
                  </button>
                </div>
          ...
          <p className="mt-5 text-center text-[12px] leading-5 text-ink/35">
            By signing in you agree to our learning community guidelines.
          </p>
        </div>
      </main>
    </div>
